...
THRESHOLDS: dict[str, dict[str, Any]] = {
    ...
    "lunge": {
        "rom": {
            # Front knee angle at bottom of lunge.
            # 90° = ideal; shallower = not enough depth.
            "joint": "front_knee_angle",
            "min_good": 85.0,
            "max_good": 100.0,
            "min_acceptable": 65.0,
            "max_acceptable": 150.0,
            "ideal": 90.0,
            "feedback": {
                "too_low":  "Front knee past toes — shift weight to heel.",
                "good":     "Perfect lunge depth — 90° front knee.",
                "too_high": "Step forward more — aim for a 90° knee bend.",
            },
        },
        "symmetry": {
            # Compare left-lunge vs right-lunge angles across reps
            "perfect":     0.05,
            "acceptable":  0.15,
            "poor":        0.25,
            "feedback": {
                "good":   "Both legs lunging evenly.",
                "medium": "Stronger on one side — practice weak side more.",
                "poor":   "Significant leg imbalance — address hip flexor tightness.",
            },
        },
        "stability": {
            "perfect":    0.03,
            ...
            "poor":       0.15,
            "feedback": {
                "good":   "Balanced landing — strong single-leg stability.",
                "medium": "Some wobble — engage core and look forward.",
                "poor":   "Unstable lunge — use a wall for support initially.",
            },
        },
        "smoothness": {
            "perfect":    0.12,
            ...
            "poor":       0.50,
            "feedback": {
                "good":   "Controlled lunge tempo — well done.",
                "medium": "Slightly abrupt — step with more control.",
                "poor":   "Slamming into the lunge — slow down significantly.",
            },
        },
        "weights": {"rom": 0.30, "symmetry": 0.25, "stability": 0.25, "smoothness": 0.20},
    },
...
def _run_tests() -> None:
    ...
    test_cases = [
        ...
        },
        {
            ...
            "exercise": "lunge",
            "features": {
                "front_knee_angle": 140.0,  # insufficient depth
                "symmetry_index":   0.28,   # large leg imbalance
                "stability":        0.13,   # unstable landing
                "smoothness":       0.48,
            },
        },
    ]
